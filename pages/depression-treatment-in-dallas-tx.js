...
const DepressionTreatmentDetails = dynamic(() =>
  import(
    "../components/TmsHome/TmsDetailContent/depression-treatment-details.js"
  )
);
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="We know everyone's depression experience is different, so we adjust our treatment plans to your requirements and goals at Premier Pain Centers."
        />
      ...
      <PageBanner
        pageTitle="Depression Treatment Centers in Dallas, TX"
        homePageUrl="/"
        homePageText="Home"

...
const Navbar = () => {
  ...
  return (
    <>
      <nav id="navbar" className="navbar navbar-expand-lg navbar-light bg-white sticky-top shadow-sm">
        <div className="container-fluid">
          {/* Brand Logo */}
          ...
          <div className={`collapse navbar-collapse ${isMenuOpen ? 'show' : ''}`} id="navbarNav">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link
                  href="/"
                  className={`nav-link ${currentPath === "/" ? "active fw-bold" : ""}`}
                  onClick={closeMenu}
                >
                  Home
                </Link>
              ...
              <li className="nav-item dropdown">
                <a
                  className={`nav-link dropdown-toggle ${currentPath.includes("/conditions-we-treat/") ? "active fw-bold" : ""}`}
                  href="#"
                ...
                <ul className="dropdown-menu" aria-labelledby="conditionsDropdown">
                  <li>
                    <Link href="/conditions-we-treat/car-accident-injury/" className="dropdown-item" onClick={closeMenu}>
                      Car Accident Injury
                    </Link>
                  </li>
                  <li>
                    <Link href="/conditions-we-treat/shoulder-pain/" className="dropdown-item" onClick={closeMenu}>
                      Shoulder Pain
                    </Link>
                  </li>
                  <li>
                    <Link href="/conditions-we-treat/sports-injury/" className="dropdown-item" onClick={closeMenu}>
                      Sports Injury
                    </Link>
                  </li>
                  <li>
                    <Link href="/conditions-we-treat/headaches/" className="dropdown-item" onClick={closeMenu}>
                      Headaches
                    </Link>
                  </li>
                  <li>
                    <Link href="/conditions-we-treat/back-pain/" className="dropdown-item" onClick={closeMenu}>
                      Back Pain
                    </Link>
                  </li>
                  <li>
                    <Link href="/conditions-we-treat/neck-pain/" className="dropdown-item" onClick={closeMenu}>
                      Neck Pain
                    </Link>
                  </li>
                  <li>
                    <Link href="/conditions-we-treat/knee-pain/" className="dropdown-item" onClick={closeMenu}>
                      Knee Pain
                    </Link>
                  </li>
                  <li>
                    <Link href="/conditions-we-treat/joint-pain/" className="dropdown-item" onClick={closeMenu}>
                      Joint Pain
                    </Link>
                  </li>
                  <li>
                    <Link href="/conditions-we-treat/leg-pain/" className="dropdown-item" onClick={closeMenu}>
                      Leg Pain
                    </Link>
                  </li>
                  <li>
                    <Link href="/conditions-we-treat/hip-pain/" className="dropdown-item" onClick={closeMenu}>
                      Hip Pain
                    </Link>
                  </li>
                </ul>
              ...
              <li className="nav-item dropdown">
                <a
                  className={`nav-link dropdown-toggle ${currentPath.includes("/psychiatric-services-in-dallas-tx/") || currentPath.includes("/tms-therapy/") || currentPath.includes("/talk-therapy-dallas/") ? "active fw-bold" : ""}`}
                  href="#"
                ...
                <ul className="dropdown-menu" aria-labelledby="psychiatryDropdown">
                  <li>
                    <Link href="/tms-therapy/" className="dropdown-item" onClick={closeMenu}>
                      TMS Therapy
                    </Link>
                  </li>
                  <li>
                    <Link href="/talk-therapy-dallas/" className="dropdown-item" onClick={closeMenu}>
                      Talk Therapy
                    </Link>
                  </li>
                  <li>
                    <Link href="/dallas-counseling-services/" className="dropdown-item" onClick={closeMenu}>
                      Counseling
                    </Link>
                  </li>
                  <li>
                    <Link href="/medication-management-in-dallas/" className="dropdown-item" onClick={closeMenu}>
                      Medication Management
                    </Link>
                  </li>
                </ul>
              ...
              <li className="nav-item dropdown">
                <a
                  className={`nav-link dropdown-toggle ${currentPath.includes("/treatments/") ? "active fw-bold" : ""}`}
                  href="#"
                ...
                <ul className="dropdown-menu" aria-labelledby="treatmentsDropdown">
                  <li>
                    <Link href="/treatments/hip-joint-injections/" className="dropdown-item" onClick={closeMenu}>
                      Hip Joint Injections
                    </Link>
                  </li>
                  <li>
                    <Link href="/treatments/disc-regenerative-therapy/" className="dropdown-item" onClick={closeMenu}>
                      Disc Regenerative Therapy
                    </Link>
                  </li>
                  <li>
                    <Link href="/treatments/mild-procedure/" className="dropdown-item" onClick={closeMenu}>
                      Mild Procedure
                    </Link>
                  </li>
                  <li>
                    <Link href="/treatments/facet-joint-injection/" className="dropdown-item" onClick={closeMenu}>
                      Facet Joint Injection
                    </Link>
                  </li>
                  <li>
                    <Link href="/treatments/percutaneous-discectomy/" className="dropdown-item" onClick={closeMenu}>
                      Percutaneous Discectomy
                    </Link>
                  </li>
                  <li>
                    <Link href="/treatments/trigger-point-injections/" className="dropdown-item" onClick={closeMenu}>
                      Trigger Point Injections
                    </Link>
                  </li>
                  <li>
                    <Link href="/treatments/joint-injections/" className="dropdown-item" onClick={closeMenu}>
                      Joint Injections
                    </Link>
                  </li>
                  <li>
                    <Link href="/treatments/lumbar-sympathetic-injections/" className="dropdown-item" onClick={closeMenu}>
                      Lumbar Sympathetic Injections
                    </Link>
                  </li>
                  <li>
                    <Link href="/treatments/epidural-nerve-block/" className="dropdown-item" onClick={closeMenu}>
                      Epidural Nerve Block
                    </Link>
                  </li>
                  <li>
                    <Link href="/treatments/si-joint-injection/" className="dropdown-item" onClick={closeMenu}>
                      Si Joint Injection
                    </Link>
                  </li>
                </ul>
              ...
              <li className="nav-item dropdown">
                <a
                  className={`nav-link dropdown-toggle ${currentPath.includes("/meet-our-team/") ? "active fw-bold" : ""}`}
                  href="#"
                  id="teamDropdown"
                  role="button"
                  data-bs-toggle="dropdown"
                ...
                <ul className="dropdown-menu" aria-labelledby="teamDropdown">
                  <li>
                    <Link href="/meet-our-team/rao-k-ali/" className="dropdown-item" onClick={closeMenu}>
                      Rao K. Ali MD
                    </Link>
                  </li>
                  <li>
                    <Link href="/meet-our-team/william-moore-md/" className="dropdown-item" onClick={closeMenu}>
                      William Moore MD
                    </Link>
                  </li>
                  <li>
                    <Link href="/meet-our-team/dr-christopher-creighton/" className="dropdown-item" onClick={closeMenu}>
                      Christopher P Creighton MD
                    </Link>
                  </li>
                  <li>
                    <Link href="/meet-our-team/dr-pollard-psychiatrist-dallas/" className="dropdown-item" onClick={closeMenu}>
                      Ronnie Pollard MD
                    </Link>
                  </li>
                  <li>
                    <Link href="/meet-our-team/sharon-anna-shaji/" className="dropdown-item" onClick={closeMenu}>
                      Sharon Anna Shaji
                    </Link>
                  </li>
                </ul>
              ...
              <li className="nav-item dropdown">
                <a
                  className={`nav-link dropdown-toggle ${currentPath.includes("/contact-locations/") ? "active fw-bold" : ""}`}
                  href="#"
                  id="contactDropdown"
                  role="button"
                  data-bs-toggle="dropdown"
                ...
                <ul className="dropdown-menu" aria-labelledby="contactDropdown">
                  <li>
                    <Link href="/contact-locations/richardson/" className="dropdown-item" onClick={closeMenu}>
                      Richardson
                    </Link>
                  </li>
                  <li>
                    <Link href="/contact-locations/north-richland-hills/" className="dropdown-item" onClick={closeMenu}>
                      North Richland Hills
                    </Link>
                  </li>
                  <li>
                    <Link href="/contact-locations/waxahachie/" className="dropdown-item" onClick={closeMenu}>
                      Waxahachie
                    </Link>
                  </li>
                  <li>
                    <Link href="/contact-locations/fort-worth/" className="dropdown-item" onClick={closeMenu}>
                      Fort Worth
                    </Link>
                  </li>
                  <li>
                    <Link href="/contact-locations/hillsboro/" className="dropdown-item" onClick={closeMenu}>
                      Hillsboro
                    </Link>
                  </li>
                  <li>
                    <Link href="/contact-locations/desoto/" className="dropdown-item" onClick={closeMenu}>
                      Desoto
                    </Link>
                  </li>
                </ul>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="moreDropdown">
                  <li>
                    <Link href="/blog/" className="dropdown-item" onClick={closeMenu}>
                      Blog
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/dallas-pain-clinic/" className="dropdown-item" onClick={closeMenu}>
                      Dallas Pain Clinic
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/faqs/" className="dropdown-item" onClick={closeMenu}>
                      FAQs
                    </Link>
                  </li>
                  <li>
                    <Link href="/reviews/" className="dropdown-item" onClick={closeMenu}>
                      Reviews
                    </Link>
                  </li>
                </ul>

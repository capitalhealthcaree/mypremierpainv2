...
const AppointmentForm = () => {
  ...
  return (
    <>
      <div className="appointment-area-two pt-4 pb-5">
        <div className="container">
          <div className="row align-items-center appointment-wrap-two">
            ...
            <div className="col-lg-5">
              <h1>Expert Support Ready to Assist You!</h1>
              <p>
                Our knowledgeable team is ready to answer all your questions,
                and we look forward to helping you grow and succeed!
              </p>

              ...
              <div className="card-body p-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="d-flex align-items-start mb-2">
                    ...
                    <span className="flex-grow-1">TMS, Spravato, and IV Ketamine</span>
                  </div>
              ...
              <div className="card-body p-4">
                ...
                <div className="mb-4">
                  <div className="d-flex align-items-start mb-2">
                    ...
                    <span className="flex-grow-1">Neck, Shoulder & Back Pain</span>
                  </div>
                  ...
                  <div className="d-flex align-items-start mb-2">
                    ...
                    <span className="flex-grow-1">Hip, Knee, Joint & Leg Pain</span>
                  </div>
                  ...
                  <div className="d-flex align-items-start mb-2">
                    ...
                    <span className="flex-grow-1">Headaches & Sports Injuries</span>
                  </div>
                </div>
